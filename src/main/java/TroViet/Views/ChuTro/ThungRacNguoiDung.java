 ...
 * @author WINDOWS
 */
public class ThungRacNguoiDung extends javax.swing.JFrame {

    /**
     * Creates new form ThungRacNguoiDung
     */
    ...
    public void initTable() {
        tableModel = (DefaultTableModel) tblThungRacNguoiDung.getModel();
    ...
    public void fillToTableOrder() {
        ...
        try {
            for (UserEntity user : userDao.getAllFromRecycle()) {
    ...
    public Long[] getSelectedIds() {
        ...
        int selectedRows[] = tblThungRacNguoiDung.getSelectedRows();
        Long selectedIds[] = new Long[selectedRows.length];
        for (int i = 0; i < selectedRows.length; i++) {
            int selectedRow = selectedRows[i];
            Long id = (Long) tblThungRacNguoiDung.getValueAt(selectedRow, 0);
            selectedIds[i] = id;
        }
        return selectedIds;
    }
    ...
    private void initComponents() {
        ...
        tblThungRacNguoiDung.setFont(new java.awt.Font("Segoe UI", 0, 14)); // NOI18N
        tblThungRacNguoiDung.setForeground(new java.awt.Color(40, 46, 62));
        ...
        tblThungRacNguoiDung.setGridColor(new java.awt.Color(255, 255, 255));
        tblThungRacNguoiDung.setSelectionBackground(new java.awt.Color(46, 56, 86));
        tblThungRacNguoiDung.setSelectionForeground(new java.awt.Color(255, 205, 31));
        ...
        Long selectedIds[] = getSelectedIds();
            try {
                ...
                for (int i = 0; i < selectedIds.length; i++) {
                    userDao.RestoreFromRecycle(selectedIds[i]);             
                }                
                 fillToTableOrder();
                 SessionEntity ss = new SessionEntity();
            ss.setUser(userSS);
            ss.setMessage("Khôi phục người dùng đã xóa");
    ...
    private void btnXoaVinhVienActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnXoaVinhVienActionPerformed
        ...
        Long selectedIds[] = getSelectedIds();
            try {
                if (JOptionPane.showConfirmDialog(null, "Xác nhận xóa vĩnh viễn?", "Xóa người dùng", ERROR_MESSAGE) != YES_OPTION) {
                    return;
                }
                for (int i = 0; i < selectedIds.length; i++) {
                ...
                SessionEntity ss = new SessionEntity();
            ss.setUser(userSS);
            ss.setMessage("Xóa người dùng vĩnh viễn");
            ss.setStartTime(new Timestamp(System.currentTimeMillis()));
            sessionDao.save(ss);
            SessionEntity sss = sessionDao.getLast(userSS.getId());
            setSession(sss);
            } catch (Exception e) {
                JOptionPane.showMessageDialog(null, "Bạn còn rằng buộc với Người Dùng");
                e.printStackTrace();
            }
...
//            java.util.logging.Logger.getLogger(ThungRacNguoiDung.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
...
//            public void run() {
//                new ThungRacNguoiDung().setVisible(true);
//            }
//        });
//    }
