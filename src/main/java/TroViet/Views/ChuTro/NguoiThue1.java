 ...
 * @author Admin
 */
public class NguoiThue1 extends javax.swing.JFrame {

    /**
     * Creates new form NguoiThue1
     */
    PhongTroDAO Dao = new PhongTroDAO();
    ArrayList<PhongTroDAO> listNT = new ArrayList<>();
    ...
    public void initTable() {
        model = (DefaultTableModel) tblNguoiThue.getModel();
        String[] columns = {"ID", "ID ND", "Họ Tên"};
    ...
    public void fillToTableUser() {
        ...
        try {
            ...
            String query = "SELECT PhongTro.Id, NguoiDung.Id, NguoiDung.HoTen\n"
                    + "FROM (PhongTro\n"
                    + "INNER JOIN NguoiDung ON PhongTro.Id=NguoiDung.Id) where NguoiDung.VaiTro = 'Tenants'; ";
            ResultSet rs = statement.executeQuery(query);
            while (rs.next()) {
//            PhongTro order = getFromResultSet(rs);
...
//            java.util.logging.Logger.getLogger(NguoiThue1.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
...
//            public void run() {
//                new NguoiThue1().setVisible(true);
//            }
//        });
//    }
