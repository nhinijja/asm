...
public class DangKy extends javax.swing.JFrame {
    ...
    private static String generateConfirmationCode() {
        ...
        String confirmationCodeWithExpiration = String.format("%06d-%s", confirmationCode, expirationTime.format(DateTimeFormatter.ofPattern("yyyy-MM-dd HH:mm:ss")));
    ...
    private void sendConfirmationCode() {
        ...
        String username = System.getenv("EMAIL_USERNAME"); // Lấy từ biến môi trường
        String password = System.getenv("EMAIL_PASSWORD"); // Lấy từ biến môi trường
        ...
        try {
            ...
            e.printStackTrace();
            JOptionPane.showMessageDialog(this, "Lỗi quá trình xác nhận. Vui lòng thử lại.");
        }
    }
